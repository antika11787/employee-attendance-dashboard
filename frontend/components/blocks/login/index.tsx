        ...
        <div className='login-page'>
            <div className='login-container'>
                <div className='login-left'>
                    <Image src={'/stats.gif'} alt="login-image" height={400} width={400} className='login-image' />
                </div>
                <div className='login-right'>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className='login-form'>
                        ...
                        <p className='signup-form-text'>Do not have an account? <Link href="/signup" className='signup-form-link'>Sign Up</Link></p>
                    </form>
                </div>
            </div>
        </div>
